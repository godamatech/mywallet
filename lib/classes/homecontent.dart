    ...
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.symmetric(
            horizontal: 20.0), // Horizontal padding for the body.
        child: Column(
      ...
      child: Column(
        ...
        children: [
          CircleAvatar(
            ...
            child: Icon(icon,
                color: Colors.orangeAccent, size: 30), // Orange accent icon.
          ),
...
Widget _materCardSection() {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      border:
          Border.all(color: Colors.orangeAccent, width: 2), // Orange border.
      boxShadow: [
        BoxShadow(
