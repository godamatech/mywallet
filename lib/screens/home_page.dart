...
class HomePage extends StatefulWidget {
  ...
  _HomePageState createState() =>
      _HomePageState(); // Creates the state for the HomePage widget.
}
...
class _HomePageState extends State<HomePage> {
  ...
  final Color primaryColor = const Color(
      0xFF4A90E2); // Primary color matching the login/signup screens.
  final Color backgroundColor = const Color(
      0xFFF5F7FA); // Background color matching the login/signup screens.
  final Color bottomNavSelectedColor =
      const Color(0xFF4A90E2); // Color for the selected bottom navigation item.
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int index) {
          setState(() {
            currentIndex =
                index; // Updates the state to reflect the new selected tab.
          });
        },
        items: const [
        ...
        selectedItemColor:
            bottomNavSelectedColor, // Color for the selected item.
        unselectedItemColor:
            bottomNavUnselectedColor, // Color for the unselected items.
        backgroundColor:
        ...
        type: BottomNavigationBarType
            .fixed, // Type of bottom navigation bar (fixed width for items).
      ),
    );
  }
}
